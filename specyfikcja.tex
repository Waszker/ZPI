...
\begin{itemize}
    ...
    \item co najmniej dwóch programistów posiadających certyfikat potwierdzający ich umiejętności programowania w technologii ASP.NET %TODO: YOLO i zostawiamy? ~nope
\end{itemize}
...
\begin{enumerate}
    \item Umowa będzie realizowana od daty jej zawarcia i w okresie nie dłuższym niż do dnia 30 stycznia 2018 r., zgodnie ze szczegółowym Harmonogramem
    ...
    \begin{enumerate}
        ...
        \item Po realizacji etapów 1, 2 i 3 Wykonawca zobowiązuje się do wsparcia technicznego oraz zapewnienia usług serwisowych przez okres dwóch lat, nie później niż do 30 stycznia 2018 r.
    \end{enumerate}
\end{enumerate}
